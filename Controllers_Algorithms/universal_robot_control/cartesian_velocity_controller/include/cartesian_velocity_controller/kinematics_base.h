...
{
class Kinematics_Base: public controller_interface::Controller<hardware_interface::VelocityJointInterface>
{
public:
  Kinematics_Base() {}
  ~Kinematics_Base() {}
...
bool Kinematics_Base::init(hardware_interface::VelocityJointInterface *robot, ros::NodeHandle &n)
  {
    nh_ = n;
