...
public:
   ...
   */
  // void command_joint_torque(const joint_effort_msg::JointEffort &msg);
    void command_joint_torque(const joint_effort_msg::JointEfforts &msg);
private:
...
//   cartesian_state_msgs::PoseTwist msg_state_;
  ...
  boost::shared_ptr<realtime_tools::RealtimePublisher
              <joint_state_msg::JointState>> realtime_pub_;
};
