#ifndef JOINT_TORQUE_CONTROLLER_KINEMATICS_BASE_H
#define JOINT_TORQUE_CONTROLLER_KINEMATICS_BASE_H
...
bool Kinematics_Base::init(hardware_interface::EffortJointInterface *robot, ros::NodeHandle &n)
  {
    nh_ = n;
...
#endif // JOINT_TORQUE_CONTROLLER_KINEMATICS_BASE_H
