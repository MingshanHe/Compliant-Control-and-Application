 ...
 * @Licence: MIT Licence
 */
#ifndef CARTESIAN_MPC_CONTROLLER_H
#define CARTESIAN_MPC_CONTROLLER_H
 ...
 * of the controller.
 */
class Cartesian_MPC_Controller: public kinematics_base::Kinematics_Base
{
public:
  Cartesian_MPC_Controller() {}
  ~Cartesian_MPC_Controller() {}
