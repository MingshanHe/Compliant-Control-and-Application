#ifndef CARTESIAN_INVERSE_DYNAMIC_CONTROLLER_KINEMATICS_BASE_H
#define CARTESIAN_INVERSE_DYNAMIC_CONTROLLER_KINEMATICS_BASE_H
...
class Kinematics_Base: public controller_interface::Controller<hardware_interface::EffortJointInterface>
{
public:
    Kinematics_Base(){}
    ~Kinematics_Base(){}
...
bool Kinematics_Base::init(hardware_interface::EffortJointInterface *robot, ros::NodeHandle &nh)
{
    nh_ = nh;
...
#endif // CARTESIAN_INVERSE_DYNAMIC_CONTROLLER_KINEMATICS_BASE_H