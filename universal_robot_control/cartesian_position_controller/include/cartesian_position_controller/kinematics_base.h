 ...
 * @Licence: MIT Licence
 */
#ifndef CARTESIAN_POSITION_CONTROLLER_KINEMATICS_BASE
#define CARTESIAN_POSITION_CONTROLLER_KINEMATICS_BASE
...
#endif // CARTESIAN_POSITION_CONTROLLER_KINEMATICS_BASE
